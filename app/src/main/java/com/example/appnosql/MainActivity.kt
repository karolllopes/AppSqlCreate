...
fun addDataToDatabase(
    ...
    Column(
        ...
        TextField(
            ...
            placeholder = { Text(text = "*O nome do seu curso*") },
            modifier = Modifier
                .fillMaxWidth(),
        ...
        TextField(
            ...
            placeholder = { Text(text = "*Qual a duração de seu curso*") },
            modifier = Modifier
                .fillMaxWidth(),
            textStyle = TextStyle(color = Color.Blue, fontSize = 16.sp),
            singleLine = true,
        ...
        TextField(
            ...
            placeholder = { Text(text = "*Curso do seus sonhos*") },
            modifier = Modifier
                .fillMaxWidth(),
            textStyle = TextStyle(color = Color.Blue, fontSize = 16.sp),
            singleLine = true,
        ...
        TextField(
            ...
            placeholder = { Text(text = "*Descreva o curso em que está hoje*") },
            modifier = Modifier
                .fillMaxWidth(),
            textStyle = TextStyle(color = Color.Blue, fontSize = 16.sp),
            singleLine = true,
